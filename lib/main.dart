...
import 'package:todolist_2/firebase_options.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: {
          ...
          TodoListPage.path: (_) => TodoListPage(),
          CreateTodoPage.path: (_) => const CreateTodoPage(),
          TodoDetailPage.path: (_) => TodoDetailPage()
        },
        home: LoginPage()
        // home: StreamBuilder(
